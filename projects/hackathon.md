...
end was done in JavaScript using [plotly.js](https://plotly.com/javascript). It
took a lot of work, but I managed to complete all the features I wanted to in
...
relatively easy to pronounce and spell, at least as far as Elvish goes!

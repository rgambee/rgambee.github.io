...
<img class="centered" src="/media/housing.jpg" alt="The housing of one of our final prototypes" title="The housing of one of our final prototypes" style="width: 60%;">
...
<img class="centered" src="/media/thermalSim.png" alt="Simulation of steady-state temperature distribution" title="Simulation of steady-state temperature distribution" style="width: 60%;">
...
<img class="centered" src="/media/BTOmodel.png" alt="COMSOL model of BTO nanoparticle slurry" title="COMSOL model of BTO nanoparticle slurry" style="width: 60%">
